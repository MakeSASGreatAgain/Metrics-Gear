...
`docker run -e SERVER=с2-185-12-28-165.elastic.cloud.ru -e USERNAME=Team7 -e PASSWORD=Team71!ijn -e PORT=1433 -e DEBUG=app -p 4000:4000 --name prometheus-mssql-exporter awaragi/prometheus-mssql-exporter`
